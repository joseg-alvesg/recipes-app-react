          ...
          && recipes.slice(startIndex, endIndex).map((data, i) => (
            <div
              ...
              className="col d-flex flex-column align-items-center justify-content-center
                p-1 col-4  rounded col-sm-3 col-md-3 col-lg-2 col-xl-2 col-xxl-2"
            ...
            >
              <div className="card rounded p-0 body w-100">
                ...
                />
                <div
                  className="card-img-overlay d-flex p-0 flex-column
                  justify-content-end"
                >
                  <h4
                    className="card-title text-truncate p-1 m-0 text-light
                    text-center fs-sm-1"
